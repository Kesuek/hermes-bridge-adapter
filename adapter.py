...
class BridgeAdapter(BasePlatformAdapter):
    ...
    def _unified_help_text() -> str:
        return (
            ...
            "  /u c <name>                  create <name> — new thread\n"
            "  /u j <name>                  join <name> — join a thread\n"
            "  /u l <name>                  leave <name> — remove membership\n"
            "  /u s <name>                  switch <name> — set active thread\n"
            "  /u x                         exit — leave session, back to normal chat\n"
            "  /u d <name> <msg>            send <name> <msg> — one-shot multicast\n"
            "  /u me <name>                 members <name> — list members\n"
            "  /u st                        status — list your threads\n"
            "  /u m <name> <mode>           mode — participant | reactive | off | silent | protokoll\n"
            "  set username <name>          set your display name\n"
